...
class ControlDriving():
    def __init__(self):
        ...
        self.Kp = float(os.getenv('KP', 2.8))
        self.Kd = float(os.getenv('KD', 0.05))
        self.Ki = float(os.getenv('KI', 0.82))
        ...
        self.loop_rate = rospy.Rate(10) # 10hz->10
    ...
    def fnNormalDriving(self):
        ...
        print("angular_z: {:.3f}".format(angular_z))
